...
class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    private static final String DEFAULT_SHARED_PREFERENCES_NAME = "FlutterLocalKeyValueStorage";
    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        ...
        String storageName = call.argument("storageName");

        final SharedPreferences preferences = context.getSharedPreferences(
                storageName != null ? storageName : DEFAULT_SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE
        );
        ...
        try {
            switch (call.method) {
                ...
                case "remove":
                    ...
                    break;
                case "clear":
                    Set<String> keySet = getAllPrefs(preferences).keySet();
    ...
    private Map<String, Object> getAllPrefs(SharedPreferences preferences) throws IOException {
